...
\begin{tabular}{|l|l|r|r|}
    ...
    \hline
\end{tabular}
\caption{Classification results for logistic regression vs neural nets. Training had a learning rate of $0.01$ with Adam's default settings, a batch size of $2048$, and $100$ epochs.}
