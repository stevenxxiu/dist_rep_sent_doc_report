...
\begin{tabular}{|l|l|l|l|l|l|l|r|}
    ...
    \hline
\end{tabular}
\caption{\texttt{pv-dm} and \texttt{dbow} results for logistic regression classification. All results use a learning rate of $0.001$, and a batch size of $2048$.}
\label{table:doc_emb}
\end{table}
...
\begin{tabular}{|l|l|l|r|}
    ...
    \hline
\end{tabular}
\caption{Classification results for logistic regression vs neural nets. All results use a learning rate of $0.1$, $30$ epochs, and a batch size of $2048$.}
